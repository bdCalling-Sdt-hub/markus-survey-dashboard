...
import { useGetCompanyQuery } from "../../redux/api/baseapi.js";
  ...
  return (
    <>
      <div className="grid-3 gap-3">
        {data?.map((item, index) => (
          <div
            className="w-full h-full center-center flex-col gap-3 py-7 bg-[var(--color-7)] p-2 rounded-md"
            key={index}
          >
      ...
      <div className="mt-3 bg-white rounded-md">
        <div className="between-center gap-2 mb-3 p-5">
          ...
          <Link to={`/super-admin/company-details`}>View All</Link>
        </div>
        <UserDeleteRequest />
      </div>
    </>
